...
[size110]#&nbsp;&nbsp;&nbsp;&nbsp; https://github.com/java9-modularity/gradle-modules-plugin#compilation-to-a-specific-java-release[gradle-modules-plugin]# +
[size110]#&nbsp;&nbsp;&nbsp;&nbsp; https://github.com/beryx/badass-jar-plugin[badass-jar-plugin]#
